...
<meta charset="utf-8"><title>Chipper Request Form</title>
...
<h1>Neighborhood Chipper Request Form</h1>

<div class="info_text">
<p>A minimum of three households are required to participate in this free chipper program.</p>
</div>
<form action="mailer_chipper.php" method="POST">
...
<div>
<p>When do you want the chipper?</p>
<input name="removal_date" type="date"  > <br> </div>


<div>
<p>Addresses of Homes Served</p>
<input name="pile" type="text"> <br> </div>
